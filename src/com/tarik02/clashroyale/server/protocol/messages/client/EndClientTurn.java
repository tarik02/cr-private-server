...
import com.tarik02.clashroyale.server.protocol.messages.component.CommandComponent;
...
public class EndClientTurn extends Message {
	...
	public EndClientTurn() {
		...
		tick = 0;
		checksum = 0;
		commands = new CommandComponent[0];
		unknown_3 = 0;
		unknown_4 = 0;
		unknown_5 = 0;
		unknown_6 = 0;
	...
	public void encode(DataStream stream) {
		...
		commands = new CommandComponent[stream.getRrsInt32()];
	...
	public void decode(DataStream stream) {
		...
		stream.putRrsInt32((int)commands.length);
		for (int i = 0; i < commands.length; ++i) {
